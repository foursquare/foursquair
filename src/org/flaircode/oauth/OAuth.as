...
package org.flaircode.oauth
{
	...
	public class OAuth implements IOAuth
	{
		 ...
		 * 
		 */		
		public function buildRequest(method:String, url:String, token:OAuthToken=null, requestParams:Object = null):URLRequest
		{
			...
			if(method=="POST"){
				request.url = url;
				request.data = oauthRequest.buildRequest(signature, OAuthRequest.RESULT_TYPE_POST);
			}
			else{
			   request.url = oauthRequest.buildRequest(signature, OAuthRequest.RESULT_TYPE_URL_STRING);
			}
